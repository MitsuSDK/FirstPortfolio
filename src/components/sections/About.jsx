    ...
    >
      <RevealOnScroll>
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-[#6812e3] to-[#f100ff] bg-clip-text text-transparent text-center">
            {" "}
            About Me
          </h2>
              ...
              <div className="rounded-xl p-6 hover:-translate-y-1 transition-all">
                ...
                <div className="flex flex-wrap gap-2">
                  {backendSkills.map((tech, key) => (
                    <span
                      key={key}
                      className="bg-purple-500/10 text-[#6812e3] py-1 px-3 rounded-full text-sm hover:bg-purple-500/20 
